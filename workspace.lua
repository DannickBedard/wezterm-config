...
local windowNvimPath = "C:\\Users\\danni\\AppData\\Local\\nvim"
local windowWeztermPath = "C:\\Users\\danni\\wezterm-config"

local settings = {
  currentConfig = configs.personalWindow, -- À changer selon l'ordinateur utilisé
  workspaceProject = {
    work = {
      project1 = {
        path = "/viridem",
